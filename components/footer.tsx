        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              />
              <div>
                <h3 className="text-xl font-bold">JOMAR S.A.S.</h3>
                <p className="text-sm text-primary-foreground/80">Compromiso, calidad y confianza</p>
              </div>
            </div>
            <p className="text-primary-foreground/90 mb-4">
              Empresa líder en logística y transporte en La Guajira. Más de 10 años de experiencia sirviendo a la
              región.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm">Riohacha, La Guajira, Colombia</span>
              </div>
              <div className="flex items-center gap-2">
                <Phone className="w-4 h-4" />
                <a href="tel:+573135600630" className="text-sm hover:text-secondary transition-colors">
                  313 560 0630
                </a>
              </div>
              <div className="flex items-center gap-2">
                <Phone className="w-4 h-4" />
                <a href="tel:+573016963872" className="text-sm hover:text-secondary transition-colors">
                  301 696 3872
                </a>
              </div>
              <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-primary-foreground/90 mb-4 text-sm">
              Mantente informado de nuestros servicios y novedades
            </p>
            <div className="flex gap-3">
              <a
                ...
                className="bg-white/10 p-3 rounded-full hover:bg-green-500 transition-colors"
                aria-label="WhatsApp"
              >
